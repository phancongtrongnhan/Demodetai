<?php
	...
	if(isset($_POST['data'])){
		...
		$insertorder = "INSERT INTO `bill` (`IdBill`, `IdUser`, `IdTable`, `IdStore`, `IdCustomer`, `create_at`, `Sale`, `Status`, `Totalprice`, `Note`) VALUES ('$idbill', '$user', '$table_id', NULL, '$customer_id',NULL,NULL,'0', '$customer_pay', '$note')";
